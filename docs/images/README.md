...
`demo-frame.webp` is a synthetic demonstration asset generated with OpenAI's
built-in image-generation tool on 2026-08-21. It does not contain a personal
archive photograph, a real person's likeness, or private location metadata.
It is distributed with this repository under AGPL-3.0 to the extent copyright
applies.
